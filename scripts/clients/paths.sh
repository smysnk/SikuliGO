...
readonly ROOT_DIR API_DIR CLIENT_NODE_DIR CLIENT_PYTHON_DIR CLIENT_LUA_DIR NODE_BIN_PACKAGES_DIR NODE_PACKAGE_JSON NODE_PACKAGE_LOCK PYTHON_PROJECT_TOML
