...
nav_key: strategy
kicker: Secondary
lead: Architecture plans, client strategy, docs ownership, and the guide-format implementation plan.
---
...
- [ORB Search Delivery]({{ '/strategy/orb-search-delivery' | relative_url }})
